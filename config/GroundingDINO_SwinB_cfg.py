...
# Azhar's canonical version with kitti labels
'''
data_aug_scales = [480, 512, 544, 576, 608, 640, 672, 704, 736, 768, 800]
data_aug_max_size = 1333
data_aug_scales2_resize = [400, 500, 600]
...
dn_bbox_coef = 1.0
embed_init_tgt = True
dn_labelbook_size = 2000 # Different in IDEA than in OpenGroundingDino. Deferring to IDEA.
max_text_len = 256 # Different in IDEA than in OpenGroundingDino. Deferring to IDEA.
text_encoder_type = "bert-base-uncased"
use_text_enhancer = True
use_fusion_layer = True
use_checkpoint = True
...
# OpenGroundingDino specific settings
data_aug_scales = [480, 512, 544, 576, 608, 640, 672, 704, 736, 768, 800]
data_aug_max_size = 1333
data_aug_scales2_resize = [400, 500, 600]
data_aug_scales2_crop = [384, 600]
...
freeze_keywords = ['bert', 'backbone.0']
lr_backbone = 1e-05                           # specific learning rate
lr_backbone_names = ['backbone.0', 'bert']
lr_linear_proj_mult = 1e-05
lr_linear_proj_names = ['ref_point_head', 'sampling_offsets']
